...
<code>A \\cup B</code> → <strong>A ∪ B (union)</strong>
</div>

<div style={{ fontSize: '1.05em', textAlign: 'center', margin: '1em 0' }}>
<code>A \\cap B</code> → <strong>A ∩ B (intersection)</strong>
</div>

<div style={{ fontSize: '1.05em', textAlign: 'center', margin: '1em 0' }}>
<code>p \\land q</code> → <strong>p ∧ q (logical and)</strong>
</div>
...
<div style={{ fontSize: '1.05em', textAlign: 'center', margin: '1em 0' }}>
<code>\\sum_&#123;i=1&#125;^&#123;n&#125; a_i</code> → <strong>Σ(i=1 to n) aᵢ</strong>
</div>

<div style={{ fontSize: '1.05em', textAlign: 'center', margin: '1em 0' }}>
<code>\\int_a^b f(x)\\,dx</code> → <strong>∫ᵃᵇ f(x) dx</strong>
</div>

<div style={{ fontSize: '1.05em', textAlign: 'center', margin: '1em 0' }}>
<code>\\bigcup_&#123;i=1&#125;^&#123;n&#125; A_i</code> → <strong>⋃(i=1 to n) Aᵢ</strong>
</div>
